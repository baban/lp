...
namespace LpTest.Object
{
    ...
    public class LpNumericTest
    {
        ...
        public void initialize0()
        {
            ...
            Assert.AreEqual(0.0, o.GetType().InvokeMember("doubleValue", BindingFlags.Public | BindingFlags.Instance | BindingFlags.GetField, null, o, null));
        }
    }
    /*
